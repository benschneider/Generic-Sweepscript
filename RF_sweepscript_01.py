...
def sweep_dim1(dim_1,dim_1b):
    ...
    if vdata == 'Error':
        print 'retaking this trace'
        vdata = sweep_dim1(dim_1,dim_1b) #infinite subloops if an error persists :D
    return vdata
