...
#how to update functions of a module ? ??? or tell Python to recompile its files :
...
dim_3.set_power = dim_1.set_power
dim_3.get_power = dim_1.get_power
dim_3.name = 'RF-Power' 
dim_3.start = 10
dim_3.stop = -30
dim_3.pt = 9
...
head_1 = ['Units', 'S21 _real',
        dim_1.b_name, str(dim_1.start), str(dim_1.stop),
