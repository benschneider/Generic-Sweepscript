...
dummyD1D2 = dummy('prober', name='Probe frequency', start=4.5e9, stop=5.8e9, pt=1, sstep=6e9, stime=0.0)
dummyD1D2.D1 = D1
dummyD1D2.D2 = D2
...
vMag = sim928c(sim900, name='Magnet V R=22.19KOhm', sloti=3,
               start=-0.55, stop=0.30, pt=341,
               sstep=0.1, stime=0.020)
vMag.set_volt(0.0)
vMag.output(1)
