...
class DataStore10Vec():
    ...
    def save_data(self):
        ...
        savemtx(self._folder + self._filen_4,
                self._matrix3d_3,
                header=self._head_3)
        savemtx(self._folder + self._filen_5,
                self._matrix3d_4,
                header=self._head_4)
        savemtx(self._folder + self._filen_6,
                self._matrix3d_5,
                header=self._head_5)
        savemtx(self._folder + self._filen_7,
                self._matrix3d_6,
                header=self._head_6)
        savemtx(self._folder + self._filen_8,
                self._matrix3d_7,
                header=self._head_7)
        savemtx(self._folder + self._filen_9,
                self._matrix3d_8,
                header=self._head_8)
